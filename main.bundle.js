...
module.exports = "<div style=\"margin: 10px; width: 300px;\">\n  <input\n    class=\"form-control\"\n    placeholder=\"Enter your message\"\n    [(ngModel)]=\"txtMessage\"\n    (keyup.enter)=\"sendMessage();\"\n  >\n</div>\n<div *ngFor=\"let message of messages\">\n  <p class=\"text-info\">{{ message }}</p>\n</div>\n"
...
var ChatComponent = (function () {
    function ChatComponent() {
        ...
        this.socket = __WEBPACK_IMPORTED_MODULE_1_socket_io_client___default()('https://chat1003.herokuapp.com/');
    }
    ChatComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.socket.on('SERVER_SEND_MESSAGE', function (message) { return _this.messages.push(message); });
    };
